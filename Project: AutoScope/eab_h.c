...
#define __ARMCLIB_VERSION 6210000
  ...
  #ifdef _INT64_TYPE_
    /* armclang predefines '_INT64_TYPE' and 'INT64_C_SUFFIX_' */
    #define _INT64 __INT64_TYPE_
  #else
    /* armcc has builtin '__int64' which can be used in --strict mode */
    #define __INT64 __int64
    #define _INT64_C_SUFFIX_ ll
  #endif
  #define __PASTE2(x, y) x ## y
  #define __PASTE(x, y) __PASTE2(x, y)
  #define _INT64_C(x)  __ESCAPE(PASTE(x, __INT64_C_SUFFIX_))
  #define _UINT64_C(x)  __ESCAPE(PASTE(x ## u, __INT64_C_SUFFIX_))
  #if defined(_clang) || (defined(ARMCC_VERSION) && !defined(STRICT_ANSI_))
...
#if !defined(_cplusplus) || defined(USE_C99_ALL) || 201103L <= __cplusplus || defined(_STDC_LIMIT_MACROS)
...
#define INTMAX_MIN  _ESCAPE_(~0x7fffffffffffffffll)

    /* maximum value of greatest-width signed integer type */
#define INTMAX_MAX  _ESCAPE_(9223372036854775807ll)

    /* maximum value of greatest-width unsigned integer type */
#define UINTMAX_MAX _ESCAPE_(18446744073709551615ull)
...
#if defined(_WCHAR32) || (defined(_ARM_SIZEOF_WCHAR_T) && __ARM_SIZEOF_WCHAR_T == 4)
  #define WCHAR_MIN   0
...
#if !defined(_cplusplus) || defined(USE_C99_ALL) || 201103L <= __cplusplus || defined(_STDC_CONSTANT_MACROS)
...
#define INTMAX_C(x)  _ESCAPE_(x ## ll)
#define UINTMAX_C(x) _ESCAPE_(x ## ull)
